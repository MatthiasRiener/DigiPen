...
$('body').on('click', '.content-point ', function() {
    console.log($(this).children("p").text().trim().replaceAll(" ", "_"));
    $(".main-content").animate({scrollTop: (document.getElementsByClassName('main-content')[0].scrollTop + $(`#${$(this).children("p").text().trim().replaceAll(" ", "_")}`).position().top)}, 800, 'swing');
